...
angular.module('BuzzlogixTextAnalysisAPILib').factory('ObjectivityController',function($q,Configuration,HttpClient,APIHelper){
    return{
         ...
         */
        createReturnEnglishObjectivityPlaintext : function(body){
         ...
         * @return {promise<mixed>}
         */
        createReturnEnglishObjectivityMultipartForm : function(text){
         ...
         * @return {promise<mixed>}
         */
        createReturnEnglishObjectivityEncodedForm : function(text){
