...
angular.module('BuzzlogixTextAnalysisAPILib').factory('SentimentController',function($q,Configuration,HttpClient,APIHelper){
    return{
         ...
         */
        createReturnEnglishGeneralSentimentPlaintext : function(body){
         ...
         * @return {promise<mixed>}
         */
        createReturnEnglishGeneralSentimentMultipartForm : function(text){
         ...
         * @return {promise<mixed>}
         */
        createReturnEnglishGeneralSentimentEncodedForm : function(text){
